...
$estudiantes = array();
$message = null;
if (sizeof($_SESSION) > 0 && $_SESSION['tipo_usuario'] == "E") { //solo el usuario de tipo p podra registrar calificaciones
    $pdo = new CustomPDO();

    $usuario = $pdo->getDatosUsuario($_SESSION['id_usuario']);
    $registrosCalificaciones = $pdo->registrosCalificaciones($usuario['id_usuario']);
